...
{
    public class GetEntriesByFilterQueryHandler : IRequestHandler<GetEntriesByFilterQuery, List<GetEntriesByFilterQueryResult>>
    {
        private readonly IEntryRepository _entryRepository;

        public GetEntriesByFilterQueryHandler(IEntryRepository entryRepository)
        {
